...
<head>
	<meta charset="utf-8">
	<title>Sistema Laboratorial MC</title>
...
">
<style >@import url(https://fonts.googleapis.com/css?family=Mr+Dafoe);
...
.chrome:before {
  content: 'CONTROLE LABORATORIAL MC';
  position: absolute;
  left: 0;
  top: 0;
  z-index: 10;
...
<body>
<div id="wrapper">
  <h1 class="chrome" align="center">CONTROLE LABORATORIAL</h1>
<br>
<br>
<br>
<br>
...
<br>
<br>
	<h1 align="center "  class="dreams">Login</h1>
	...
	<center>
		...
		<br><br><a href="/cadastraPaciente" class="vectro-red">Não possui cadastro?</a>
	</center>
