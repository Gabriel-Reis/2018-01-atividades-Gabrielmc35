...
class UserController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        foreach ($esse as $e) {
            if ($e->type == 1) {
               return view('usuarios.Administrador')->with('e', $e);
            }
            else if ($e->type == 2){
                $procedimentos = Procedimento::orderBy('name')->get();
                return view('usuarios.Administrador')->with('procedimentos', $procedimentos);
            }
            else if ($e->type == 3){
                return view('usuarios.Paciente')->with('e', $e);
            }
            else if ($e->type == null){
    ...
    public function cadastraAll()
    {
        return view('usuarios.cadastraAll');
    }
    ...
    public function Paciente()
    {
        ...
        return view('usuarios.Paciente')->with('usuarios', $usuarios);
    }
